...
echo "----------------------------------------------"
qrels="/mnt/c/apps/assess/project/input/tar/2017/testing/qrels/qrels.txt"
res_file="/mnt/c/apps/assess/project/output/2017/title/testing/"
eval_file="/mnt/c/apps/assess/project/output/2017/title/testing/eval/"
