...
echo "----------------------------------------------"
qrels="/mnt/c/apps/assess/project/input/tar/2018/training/qrels/qrels.txt"
res_file="/mnt/c/apps/assess/project/output/2018/title/training/"
eval_file="/mnt/c/apps/assess/project/output/2018/title/training/eval/"
