...
//                            System.out.println(String.format("Term:%s, DocId:%s, Freq:%d, Len:%d", term, docId, info.getDocumentFrequency(), info.getDocumentLength()));
        ...
        do {
            ...
            System.out.println("________________ 4." + i + " BM 25 + RF ");
            for (int a = 0; a < f && a < baseline.size(); a++) {
                TrecResult doc = baseline.get(a);
                String[] query=topic.getQueries();
            ...
            System.out.println("Choose:" + rfDocs.get(high).getDocID() + " | " + rfDocs.get(high).getScore() + " | " + (rfDocs.get(high).getOriginalIndex() + 1));
            System.out.println("------------------------------------------");
            ...
            baseline.remove(rfDocs.get(high).getOriginalIndex());
